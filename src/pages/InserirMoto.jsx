...
import motoValidator from '../validators/motoValidator';
...
const InserirMoto = () => {
    ...
    useEffect(() => {
        if(params.id) {
            const moto = MotoService.get(params.id)

            for (let campo in moto) {
                setValue(campo, moto[campo])
            }
        }
    }, [])
    ...
    function salvar(dados) {
        ...
        if(params.id){
            MotoService.update(params.id, dados) 
          } else {
            MotoService.create(dados)
        }
            ...
            <Row>
                <Row>
                    <Col>
                        <Form.Group className='mb-3' controlId="modelo">
                            <Form.Control isInvalid={errors.modelo} {...register("modelo", motoValidator.modelo)} type="text" placeholder="Modelo"/>
                            {errors.modelo && <span className='text-danger'>{errors.modelo.message}</span>}
                        </Form.Group>
                    </Col>
                    <Col>
                        <Form.Group className='mb-3' controlId="montadora">
                            <Form.Control isInvalid={errors.montadora} {...register("montadora", motoValidator.montadora)} type="text" placeholder="Montadora"/>
                ...
                <Row>
                    ...
                    <Col>
                        <Form.Group className='mb-3' controlId="cor">
                            <Form.Control isInvalid={errors.cor} {...register("cor", motoValidator.cor)} type="text" placeholder="Cor"/>
                ...
                <Row>
                    <Form.Group className='mb-3' controlId="quilometragem">
                        <Form.Control isInvalid={errors.quilometragem} {...register("quilometragem", motoValidator.quilometragem)} type="number" placeholder="Quilometragem"/>
                        {errors.quilometragem && <span className='text-danger'>{errors.quilometragem.message}</span>}
                    </Form.Group>
                    <Col>
                        <Form.Group className='mb-3' controlId="cilindradas">
                            <Form.Control isInvalid={errors.cilindradas} {...register("cilindradas", motoValidator.cilindradas)} type="number" placeholder="Cilindradas"/>
                            {errors.cilindradas && <span className='text-danger'>{errors.cilindradas.message}</span>}
                        </Form.Group>
                    </Col>
                    <Col>
                        <Form.Group className='mb-3' controlId="placa">
                            <Form.Control 
                                ...
                                {...register("placa", motoValidator.placa)} 
                                type="text" 
                                placeholder="Placa"
                                mask="AAA99A9" 
                ...
                <Row>
                    <Col>
                        <Form.Group className='mb-3' controlId="telefone">
                            <Form.Control 
                                ...
                                {...register("telefone", motoValidator.telefone)} 
                                type="text" 
                    ...
                    <Col>
                        <Form.Group className='mb-3' controlId="cep">
                            <Form.Control 
                                ...
                                {...register("cep", motoValidator.cep)} 
                                type="text" 
                                placeholder="CEP"
                                mask="99999-999" 
                                onChange={handleChange}
                    ...
                    <Form.Group className='mb-3' controlId="foto">
                        <Form.Control {...register("foto", motoValidator.foto)} type="text" placeholder="Insira o link da imagem"/>
                    </Form.Group>
                    <Form.Group className='mb-3' controlId="valor">
                        <Form.Control isInvalid={errors.valor} {...register("valor", motoValidator.valor)} type="text" placeholder="Valor"/>
